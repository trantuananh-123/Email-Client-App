...
public class EmailMessage implements Serializable {
    ...
    public Object[] toObject() {
        return new Object[]{
            this.name, this.subject, this.from, this.content
        };
    }

    @Override
    public String toString() {
        return "EmailMessage{" + "id=" + id + ", name=" + name + ", subject=" + subject + ", from=" + from + ", to=" + to + ", cc=" + cc + ", bcc=" + bcc + ", files=" + files.size() + ", content=" + content + '}';
    }
